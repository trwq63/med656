...
namespace UAHFitVault.DataAccess.MicrosoftBandServices
{
    ...
    public class MSBandPedometerService : IMSBandPedometerService
    {
        ...
        /// <returns></returns>
        public IEnumerable<MSBandPedometer> GetMSBandPedometerData(PatientData patientData) {
            if (patientData == null)
        ...
        /// <returns></returns>
        public IEnumerable<MSBandPedometer> GetMSBandPedometerData(PatientData patientData, DateTime startTime, DateTime endTime) {
            if (patientData == null)
                return _repository.GetAll();
            else
