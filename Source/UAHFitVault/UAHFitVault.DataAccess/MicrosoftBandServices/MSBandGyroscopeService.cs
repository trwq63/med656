...
namespace UAHFitVault.DataAccess.MicrosoftBandServices
{
    ...
    public class MSBandGyroscopeService : IMSBandGyroscopeService
    {
        ...
        /// <returns></returns>
        public IEnumerable<MSBandGyroscope> GetMSBandGyroscopeData(PatientData patientData) {
            if (patientData == null)
        ...
        /// <returns></returns>
        public IEnumerable<MSBandGyroscope> GetMSBandGyroscopeData(PatientData patientData, DateTime startTime, DateTime endTime) {
            if (patientData == null)
                return _repository.GetAll();
            else
