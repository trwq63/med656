...
namespace UAHFitVault.DataAccess.MicrosoftBandServices
{
    ...
    public class MSBandCaloriesService : IMSBandCaloriesService
    {
        ...
        /// <returns></returns>
        public IEnumerable<MSBandCalories> GetMSBandCaloriesData(PatientData patientData) {
            if (patientData == null)
        ...
        /// <returns></returns>
        public IEnumerable<MSBandCalories> GetMSBandCaloriesData(PatientData patientData, DateTime startTime, DateTime endTime) {
            if (patientData == null)
                return _repository.GetAll();
            else
