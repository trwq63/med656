...
namespace UAHFitVault.DataAccess.MicrosoftBandServices
{
    ...
    public class MSBandHeartRateService : IMSBandHeartRateService
    {
        ...
        /// <returns></returns>
        public IEnumerable<MSBandHeartRate> GetMSBandHeartRateData(PatientData patientData) {
            if (patientData == null)
        ...
        /// <returns></returns>
        public IEnumerable<MSBandHeartRate> GetMSBandHeartRateData(PatientData patientData, DateTime startTime, DateTime endTime) {
            if (patientData == null)
                return _repository.GetAll();
            else
