...
namespace UAHFitVault.DataAccess.MicrosoftBandServices
{
    ...
    public interface IMSBandPedometerService
    {
        ...
        /// <returns></returns>
        IEnumerable<MSBandPedometer> GetMSBandPedometerData(PatientData patientData);
        ...
        /// <returns></returns>
        IEnumerable<MSBandPedometer> GetMSBandPedometerData(PatientData patientData, DateTime startTime, DateTime endTime);
